...
export const de = {
  ...
  makler: {
    ...
    title1: 'Akquise, die vor dem',
    titleEm: 'Erstgespräch',
    title2: ' beginnt.',
    text: 'Eigentümer suchen online nach dem Wert ihrer Immobilie, lange bevor sie einen Makler anrufen. Auf einer eigenen Seite steht, was daraus folgt und wie ich so etwas aufbaue.',
    cta: 'Für Makler ansehen',
  },
  faq: {
    eyebrow: 'FAQ',
    title1: 'Bevor Sie',
...
export const en: Dict = {
  ...
  makler: {
    ...
    title1: 'Acquisition that starts before the',
    titleEm: 'first call',
    title2: '.',
    text: 'Owners search online for what their property is worth long before they call an agent. A separate page explains what follows from that and how I build it. The page is in German.',
    cta: 'View the agents page',
  },
  faq: {
    eyebrow: 'FAQ',
    title1: 'Before you',
